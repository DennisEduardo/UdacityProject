...
def load_model(checkpoint_path):
    ...
    if checkpoint['arch'] == 'vgg16':
        ...
        print('Looks like something wrong. Base architecture not recognised.')
...
print(model)
print('The model being used is above.')
input("In your time of need press Enter to predict.")
